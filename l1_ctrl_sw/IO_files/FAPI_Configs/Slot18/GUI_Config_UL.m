...
UE(1).UL.PRB_start = 40;
UE(1).UL.PRB_len = 40;
UE(1).UL.N_BWP_SIZE = 40;
UE(1).UL.newTX = true;
UE(1).UL.rv = 0;
UE(1).UL.rv_idx = 0;
...
UE(1).UL.DMRS.startingRB = 40;
UE(1).UL.DMRS.nrofRBs = 40;
...
UE(4).UL.PRB_start = 230;
UE(4).UL.PRB_len = 40;
UE(4).UL.N_BWP_SIZE = 40;
UE(4).UL.newTX = true;
UE(4).UL.rv = 0;
UE(4).UL.rv_idx = 0;
...
UE(4).UL.DMRS.scramblingID0 = 2000;
UE(4).UL.DMRS.scramblingID1 = 2000;
...
UE(4).UL.DMRS.startingRB = 230;
UE(4).UL.DMRS.nrofRBs = 40;
UE(4).UL.SRS.enabled = false;
