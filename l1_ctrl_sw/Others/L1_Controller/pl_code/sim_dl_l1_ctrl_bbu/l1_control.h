...
void ecpri_rx(hls::stream<ecpri_axis> &ecpri_in, wire_type &state_ecpri_rx, bit_wire sfn_ctrl_clk);
// Simulated module with hard-coded values
void ecpri_sim_rx(hls::stream<ecpri_axis> &ecpri_in, wire_type &state_ecpri_rx, bit_wire sfn_ctrl_clk, bool &ecpri_done);
